...
describe('validator', () => {
	...
	test('should return true when isValidObject is provided valid object with no nullable props', () => {
		...
		let result2 = isValidObject(new Member(1, 'john1eng','password','John', 'Eng', 'I like to go for walks', 'john9345@gmail.com', '(718) 444-7598)','Admin'));
	...
	test('should return false when isValidObject is provided invalid object with no nullable prop(s)', () => {
		...
		let result2 = isValidObject(new Member(1, '','','John', 'Eng', 'I like to go for walks', 'john9345@gmail.com', '(718) 444-7598)','Admin'));
	...
	test('should return false when isValidObject is provided invalid object with some nullable prop(s)', () => {
		...
		let result2 = isValidObject(new Member(1, '','password','John', 'Eng', 'I like to go for walks', 'john9345@gmail.com', '(718) 444-7598)','Admin'), 'member_id');
